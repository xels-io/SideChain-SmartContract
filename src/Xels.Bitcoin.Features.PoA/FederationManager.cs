...
namespace Xels.Bitcoin.Features.PoA
{
    public interface IFederationManager
    {
        ...
        /// <summary>Gets the height at which the Xlc-era started.</summary>
        /// <returns>The block height at which the Xlc era started.</returns>
        /// <remarks>This is the height for which <see cref="PoANetwork.XlcMiningMultisigMembers"/> is applicable.</remarks>
    ...
    public sealed class FederationManager : IFederationManager
    {
        ...
        public void UpdateMultisigMiners(bool xlcEra)
        {
