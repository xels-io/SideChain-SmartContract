...
namespace Xels.Bitcoin.Features.ExternalApi
{
    ...
    public class ExternalApiPoller : IExternalApiPoller
    {
        ...
        public void Initialize()
        {
            ...
            {
                this.logger.LogInformation($"Price tracking for XLC and ETH enabled.");
        ...
        /// <returns>The estimated conversion transaction fee, converted from the USD total to the equivalent XLC amount.</returns>
