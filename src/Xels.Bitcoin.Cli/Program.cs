        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                if (optionList.Contains("-help") || optionList.Contains("--help") || string.IsNullOrWhiteSpace(command))
                {
                    ...
                    builder.AppendLine();
                    builder.AppendLine("[network-name]                     Name of the network - e.g. \"xlc\" or \"bitcoin\".");
                    ...
                    builder.AppendLine("-rpcport=<port>                    Connect to JSON-RPC on <port> (default for Xlc: 18000 (mainnet), 18100 (testnet) or default for Bitcoin: 8332)");
