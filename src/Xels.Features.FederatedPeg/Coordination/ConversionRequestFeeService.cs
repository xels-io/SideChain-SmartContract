...
namespace Xels.Features.FederatedPeg.Coordination
{
    ...
    public interface IConversionRequestFeeService
    {
        ...
        /// </para>
        /// <para>
        /// Each multisig node, first gets an estimated fee in XLC from an external client API for the conversion request and then broadcasts it to all the other multisig nodes.
