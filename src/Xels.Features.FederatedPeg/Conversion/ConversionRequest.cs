...
namespace Xels.Features.FederatedPeg.Conversion
{
    ...
    /// <remarks>
    /// When wSTRAX coins are minted and sent to <see cref="DestinationAddress"/> on ETH chain same amount of XLC coins should be received by the multisig address.
    /// When wSTRAX coins are burned on ETH chain same amount of XLC coins should be sent to <see cref="DestinationAddress"/>.
    /// </remarks>
    public class ConversionRequest : IBitcoinSerializable
    {
        ...
        /// <summary>
        /// Either the Ethereum address to send the minted funds to, or the XLC address to send unwrapped wSTRAX funds to.
        /// </summary>
