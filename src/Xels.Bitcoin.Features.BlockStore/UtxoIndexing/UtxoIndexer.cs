...
namespace Xels.Bitcoin.Features.BlockStore
{
    ...
    /// </summary>
    /// <remarks>This borrows heavily from the <see cref="Xels.Bitcoin.Features.SmartContracts.ReflectionExecutor.Controllers.BalancesController"/>, but is less specialised.</remarks>
