...
namespace Xels.Bitcoin.Tests.Common
{
    public static class KnownNetworks
    {
        ...
        public static Network XlcMain => NetworkRegistration.GetNetwork("XlcMain") ?? NetworkRegistration.Register(new XlcMain());

        public static Network XlcTest => NetworkRegistration.GetNetwork("XlcTest") ?? NetworkRegistration.Register(new XlcTest());

        public static Network XlcRegTest => NetworkRegistration.GetNetwork("XlcRegTest") ?? NetworkRegistration.Register(new XlcRegTest());
    }
}
