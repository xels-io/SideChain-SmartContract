...
namespace Xels.Bitcoin.Features.Miner.Tests
{
    public class PosMintingTest : LogsTestBase
    {
        ...
        public PosMintingTest()
        {
            ...
            this.network = KnownNetworks.XlcTest;
        ...
        public void CoinstakeAge_AfterActivation_Testnet()
        {
            ...
            Assert.True(this.WasUtxoSelectedForStaking(KnownNetworks.XlcTest, afterActivationHeight, afterActivationHeight - 498, false));
            Assert.False(this.WasUtxoSelectedForStaking(KnownNetworks.XlcTest, afterActivationHeight, afterActivationHeight - 497, false));
        }
        ...
        public void CoinstakeAge_AfterActivation_Mainnet()
        {
            ...
            Assert.True(this.WasUtxoSelectedForStaking(KnownNetworks.XlcMain, afterActivationHeight, afterActivationHeight - 498, false));
            Assert.False(this.WasUtxoSelectedForStaking(KnownNetworks.XlcMain, afterActivationHeight, afterActivationHeight - 497, false));
        }
        ...
        public void CoinstakeAge_PrevOutIsCoinstake_AfterActivation_Testnet()
        {
            ...
            Assert.True(this.WasUtxoSelectedForStaking(KnownNetworks.XlcTest, afterActivationHeight, afterActivationHeight - 498, true));
            Assert.False(this.WasUtxoSelectedForStaking(KnownNetworks.XlcTest, afterActivationHeight, afterActivationHeight - 497, true));
        }
        ...
        public void CoinstakeAge_PrevOutIsCoinstake_AfterActivation_Mainnet()
        {
            ...
            Assert.True(this.WasUtxoSelectedForStaking(KnownNetworks.XlcMain, afterActivationHeight, afterActivationHeight - 498, true));
            Assert.False(this.WasUtxoSelectedForStaking(KnownNetworks.XlcMain, afterActivationHeight, afterActivationHeight - 497, true));
        }
