...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// <remarks>This method is not compatible with XelsX, which always returns a JSON object no matter what parameters are passed to the second argument.</remarks>
        ...
        public async Task<Block> GetBlockAsync(uint256 blockId)
        {
            ...
            // Xelsd, however, only accepts a bool. And it unconditionally returns a JSON object, which is not useable for parsing back into a block.
