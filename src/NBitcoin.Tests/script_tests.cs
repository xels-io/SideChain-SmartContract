...
namespace NBitcoin.Tests
{
    public class Script_Tests
    {
        ...
        /// </summary>
        /// <param name="isPos">If set uses the <see cref="KnownNetworks.XlcMain"/> network (versus the <see cref="KnownNetworks.Main"/> network).</param>
        ...
        {
            Network network = isPos ? KnownNetworks.XlcMain : KnownNetworks.Main;
