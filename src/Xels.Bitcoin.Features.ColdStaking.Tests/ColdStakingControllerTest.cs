...
namespace Xels.Bitcoin.Features.ColdStaking.Tests
{
    ...
    public class ColdStakingControllerTest : TestBase
    {
        ...
        private const string hotWalletSegwitAddress1 = "xlc1qq0hrkucp54wm2xksh38gfqwrgk0k99j8q57zsh";
        private const string coldWalletSegwitAddress2 = "xlc1qx38ea6az68v8szduwnlkwk7n7r29wl7hakf90q";
        ...
        public ColdStakingControllerTest() : base(KnownNetworks.XlcMain)
        {
            ...
            var registry = (XlcStandardScriptsRegistry)this.Network.StandardScriptsRegistry;
        ...
        private void CreateMempoolManager()
        {
            ...
            var mempoolRules = new List<MempoolRule>
            {
                ...
                new XlcCoinViewMempoolRule(this.Network, this.txMemPool, this.mempoolSettings, this.chainIndexer, this.loggerFactory),
                ...
                new XlcTransactionFeeMempoolRule(this.Network, this.txMemPool, this.mempoolSettings, this.chainIndexer, this.loggerFactory),
        ...
        public void ColdStakingVerifyWalletAddresses()
        {
            ...
            string Bech32Address(HdAddress address)
            {
                ...
                var addressStr = witScript.GetDestinationAddress(KnownNetworks.XlcMain).ToString();
