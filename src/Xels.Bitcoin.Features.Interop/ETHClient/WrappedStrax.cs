...
{
    public class WrappedXlcTokenDeployment : ContractDeploymentMessage
    {
        ...
        public WrappedXlcTokenDeployment() : base(BYTECODE)
        {
        }
    ...
    public class WrappedXlc
    {
        public static async Task<string> DeployContractAsync(Web3 web3, BigInteger totalSupply)
        {
            var deploymentMessage = new WrappedXlcTokenDeployment()
            {
                TotalSupply = totalSupply
            };

            IContractDeploymentTransactionHandler<WrappedXlcTokenDeployment> deploymentHandler = web3.Eth.GetContractDeploymentHandler<WrappedXlcTokenDeployment>();
