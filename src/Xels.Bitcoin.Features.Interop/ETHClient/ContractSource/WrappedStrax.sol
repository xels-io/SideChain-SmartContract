...
contract WrappedXlcToken is ERC20, Ownable {
     ...
     * See {ERC20-_burn}.
     */
    function burn(uint256 amount, string memory xlcAddress) public {
        ...
        withdrawalAddresses[msg.sender] = xlcAddress;
    }
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount, string memory xlcAddress) public {
