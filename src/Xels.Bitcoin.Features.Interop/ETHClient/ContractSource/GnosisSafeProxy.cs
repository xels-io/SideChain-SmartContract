...
namespace Xels.Bitcoin.Features.Interop.ETHClient.ContractSource
{
    ...
    public class GnosisSafeProxy
    {
        ...
        /// <param name="proxyContract">The address of the Gnosis Safe proxy deployment that owns the wrapped XLC contract.</param>
        /// <param name="wrappedXlcContract">The address of the wrapped XLC ERC20 contract.</param>
        ...
        public static async Task<string> ExecTransactionAsync(Web3 web3, string proxyContract, string wrappedXlcContract, BigInteger value, string data, BigInteger safeTxGas, BigInteger baseGas, BigInteger gasPrice, int signatureCount, byte[] signatures)
        {
