...
namespace Xels.Bitcoin.Features.Interop
{
    ...
    public class ETHInteropSettings
    {
        ...
        /// <summary>This should be set to the address of the Wrapped XLC ERC-20 contract deployed on the Ethereum blockchain.</summary>
        public string WrappedXlcContractAddress { get; set; }
        ...
        /// signing and all interactions with the multisig and wrapped XLC contracts.
        /// </summary>
        ...
        public ETHInteropSettings(NodeSettings nodeSettings)
        {
            ...
            this.WrappedXlcContractAddress = nodeSettings.ConfigReader.GetOrDefault(wrappedXlcContractAddressKey, "");
            ...
            if (string.IsNullOrWhiteSpace(this.WrappedXlcContractAddress))
                throw new Exception($"Cannot initialize interoperability feature without -{wrappedXlcContractAddressKey} specified.");
