...
namespace Xels.Bitcoin.Tests.BlockPulling
{
    public class EnforcePeerVersionCheckBehaviorTests : LogsTestBase
    {
        ...
        public void IncompatibileNodesDisconnectAfterHardFork()
        {
            ...
            this.Network.Consensus.Options.EnforcedMinProtocolVersion = ProtocolVersion.CC_VERSION;

            // Configure local node version.
            var nodeSettings = NodeSettings.Default(this.Network, ProtocolVersion.CC_VERSION);
        ...
        public void CompatibileNodesStayConnectedAfterHardFork()
        {
            ...
            var remotePeer = CreateNetworkPeer(ProtocolVersion.CC_VERSION);
            ...
            remotePeer = CreateNetworkPeer(ProtocolVersion.CC_VERSION);
            behavior.TestOnMessageReceivedAsync(remotePeer, null);
            Assert.Equal(NetworkPeerState.Connected, localPeer.State);
        }
