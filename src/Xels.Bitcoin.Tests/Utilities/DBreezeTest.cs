...
namespace Xels.Bitcoin.Tests.Utilities
{
    ...
    public class DBreezeTest : TestBase
    {
        ...
        /// </summary>
        public DBreezeTest() : base(KnownNetworks.XlcRegTest)
        {
        ...
        {
            Block block = KnownNetworks.XlcRegTest.Consensus.ConsensusFactory.CreateBlock();
        ...
        public void DeserializerWithCoinsDeserializesObject()
        {
            ...
            var result = (Bitcoin.Utilities.Coins)this.dbreezeSerializer.Deserialize(coins.ToBytes(KnownNetworks.XlcRegTest.Consensus.ConsensusFactory), typeof(Bitcoin.Utilities.Coins));
        ...
        public void DeserializerWithBlockHeaderDeserializesObject()
        {
            ...
            var result = (BlockHeader)this.dbreezeSerializer.Deserialize(blockHeader.ToBytes(KnownNetworks.XlcRegTest.Consensus.ConsensusFactory), typeof(BlockHeader));
        ...
        public void DeserializerWithBlockDeserializesObject()
        {
            ...
            var result = (Block)this.dbreezeSerializer.Deserialize(block.ToBytes(KnownNetworks.XlcRegTest.Consensus.ConsensusFactory), typeof(Block));
