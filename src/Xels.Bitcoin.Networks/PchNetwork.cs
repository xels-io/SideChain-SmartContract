...
{
    public static class PchNetwork
    {
        ...
        public const string PchRootFolderName = "pch";

        /// <summary> The default name used for the Xlc configuration file. </summary>
        public const string PchDefaultConfigFilename = "pch.conf";
        ...
        public static void RegisterRules(IConsensus consensus)
        {
            ...
            consensus.ConsensusRules
                ...
                .Register<PchCoinviewRule>() // implements BIP68, MaxSigOps and BlockReward calculation
                                             // Place the PosColdStakingRule after the PosCoinviewRule to ensure that all input scripts have been evaluated
                                             // and that the "IsColdCoinStake" flag would have been set by the OP_CHECKCOLDSTAKEVERIFY opcode if applicable.
                //.Register<XlcColdStakingRule>()
                .Register<PchColdStakingRule>()
        ...
        public static void RegisterMempoolRules(IConsensus consensus)
        {
            consensus.MempoolRules = new List<Type>()
            {
                ...
                typeof(PchCoinViewMempoolRule),
                typeof(CreateMempoolEntryMempoolRule),
                typeof(CheckSigOpsMempoolRule),
                //typeof(XlcTransactionFeeMempoolRule),
                typeof(PchTransactionFeeMempoolRule),
        ...
        {
            { NetworkType.Mainnet, Networks.Pch.Mainnet },
            { NetworkType.Testnet, Networks.Pch.Testnet },
            { NetworkType.Regtest, Networks.Pch.Regtest }
        };
    }
}
