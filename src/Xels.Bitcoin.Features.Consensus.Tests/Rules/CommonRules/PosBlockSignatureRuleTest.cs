...
namespace Xels.Bitcoin.Features.Consensus.Tests.Rules.CommonRules
{
    public class PosBlockSignatureRuleTest : TestPosConsensusRulesUnitTestBase
    {
        ...
        {
            this.ruleContext.ValidationContext.BlockToValidate = KnownNetworks.XlcMain.Consensus.ConsensusFactory.CreateBlock();
        ...
        {
            this.ruleContext.ValidationContext.BlockToValidate = KnownNetworks.XlcMain.Consensus.ConsensusFactory.CreateBlock();
            this.ruleContext.ValidationContext.BlockToValidate.Transactions.Add(KnownNetworks.XlcMain.CreateTransaction());

            Transaction transaction = KnownNetworks.XlcMain.CreateTransaction();
        ...
        {
            Block block = KnownNetworks.XlcMain.Consensus.ConsensusFactory.CreateBlock();
            block.Transactions.Add(KnownNetworks.XlcMain.CreateTransaction());
        ...
        private void ProofOfStakeBlock_CoinStakeTestHelper(bool useCompressedKey, bool includeSecondPush, bool expectFailure)
        {
            ...
            Transaction coinStakeTransaction = KnownNetworks.XlcMain.CreateTransaction();
