...
namespace Xels.Bitcoin.Features.Consensus.Tests.Rules.CommonRules
{
    public class ConsensusRulesRegistrationTest
    {
        ...
        [Fact]
        public void XlcConsensusRulesRegistrationTest()
        {
            Network network = new XlcTest();
            ...
            partialValidationRules[10].FullName.Should().Be(typeof(XlcCoinstakeRule).FullName);
            ...
            fullValidationRules[4].FullName.Should().Be(typeof(XlcCoinviewRule).FullName);
            fullValidationRules[5].FullName.Should().Be(typeof(XlcColdStakingRule).FullName);
