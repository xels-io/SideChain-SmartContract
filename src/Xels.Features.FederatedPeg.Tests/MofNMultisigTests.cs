...
{
    public class TestXlcRegTest : XlcRegTest
    {
        internal TestXlcRegTest(Federation federation) : base()
        {
            this.Federations.RegisterFederation(federation);
            this.Name = "TestXlcRegTest";
        }
    }
    ...
    public class MofNMultiSigTests
    {
        ...
        public void Eight_Of_Fifteen_SufficientlyFunded_With_Federation()
        {
            ...
            Network network = new TestXlcRegTest(federation);
