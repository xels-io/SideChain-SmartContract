    ...
    public class CrossChainTransferStoreTests : CrossChainTestBase
    {
        ...
        public async Task StoringDepositsWhenWalletBalanceSufficientSucceedsWithDeterministicTransactionsAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                var deposit1 = new Deposit(0, DepositRetrievalType.Normal, new Money(160m, MoneyUnit.BTC), address1.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
                var deposit2 = new Deposit(1, DepositRetrievalType.Normal, new Money(60m, MoneyUnit.BTC), address2.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
        ...
        public async Task StoringDepositsWhenWalletBalanceInSufficientSucceedsWithSuspendStatusAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                var deposit1 = new Deposit(txId1, DepositRetrievalType.Normal, new Money(160m, MoneyUnit.BTC), address1.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, blockHash);
                var deposit2 = new Deposit(txId2, DepositRetrievalType.Normal, new Money(100m, MoneyUnit.BTC), address2.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, blockHash);
        ...
        public async Task SetAllAfterSuspendedToSuspendedAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                var deposit1 = new Deposit(txId1, DepositRetrievalType.Normal, new Money(1m, MoneyUnit.BTC), address1.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, blockHash);
                var deposit2 = new Deposit(txId2, DepositRetrievalType.Normal, new Money(2m, MoneyUnit.BTC), address2.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, blockHash);
                var deposit3 = new Deposit(txId3, DepositRetrievalType.Normal, new Money(3m, MoneyUnit.BTC), address3.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, blockHash);
        ...
        public async Task StoreMergesSignaturesAsExpectedAsync()
        {
            ...
            using (ICrossChainTransferStore cctsInstanceOne = this.CreateStore())
            {
                ...
                var deposit = new Deposit(1, DepositRetrievalType.Normal, new Money(160m, MoneyUnit.BTC), address.ToString(), DestinationChain.XLC, cctsInstanceOne.NextMatureDepositHeight, 1);
        ...
        public async Task StoredPartialTransactionsTriggerSignatureRequestAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                var deposit1 = new Deposit(1, DepositRetrievalType.Normal, new Money(160m, MoneyUnit.BTC), address1.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
                var deposit2 = new Deposit(2, DepositRetrievalType.Normal, new Money(60m, MoneyUnit.BTC), address2.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
        ...
        public async Task AttemptFederationInvalidWithdrawalAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                var deposit = new Deposit(0, DepositRetrievalType.Normal, new Money(160m, MoneyUnit.BTC), address.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
        ...
        public async Task StoringDepositsAfterRewindIsPrecededByClearingInvalidTransientsAndSettingNextMatureDepositHeightCorrectlyAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                // First deposit.
                var deposit1 = new Deposit(1, DepositRetrievalType.Normal, new Money(100m, MoneyUnit.BTC), address1.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
                ...
                // Second deposit.
                var deposit2 = new Deposit(2, DepositRetrievalType.Normal, new Money(100m, MoneyUnit.BTC), address2.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 2);
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                for (int i = 0; i < numDeposits; i++)
                {
                    deposits[i] = new Deposit((ulong)i, DepositRetrievalType.Normal, new Money(depositSend, MoneyUnit.BTC), address.ToString(),
                        DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
                }
                ...
                for (int i = 0; i < numDeposits; i++)
                {
                    ...
                    moreDeposits[i] = new Deposit(newId, DepositRetrievalType.Normal, new Money(depositSend, MoneyUnit.BTC), address.ToString(),
                        DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 2);
                }
        ...
        public async Task ReorgDoesntLeaveBehindUnconfirmedTransactionsAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                for (int i = 0; i < numDeposits; i++)
                {
                    deposits[i] = new Deposit((ulong)i, DepositRetrievalType.Normal, new Money(depositAmount, MoneyUnit.BTC), address.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
                }
                ...
                {
                    ulong newId = (ulong)numDeposits + (ulong)i; // to get a unique ID.
                    moreDeposits[i] = new Deposit(newId, DepositRetrievalType.Normal, new Money(depositAmount, MoneyUnit.BTC), address.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 2);
                }
        ...
        public async Task CrossChainTransferStoreDoesntCreateMassiveTransactionsAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                var deposit = new Deposit(1uL, DepositRetrievalType.Normal, new Money(depositAmount, MoneyUnit.BTC), address.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
        ...
        public async Task StoringDepositsWhenTargetIsMultisigIsIgnoredIffOurMultisigAsync()
        {
            ...
            using (ICrossChainTransferStore crossChainTransferStore = this.CreateStore())
            {
                ...
                var deposit1 = new Deposit(0, DepositRetrievalType.Normal, new Money(160m, MoneyUnit.BTC), address1.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
                var deposit2 = new Deposit(1, DepositRetrievalType.Normal, new Money(160m, MoneyUnit.BTC), address2.ToString(), DestinationChain.XLC, crossChainTransferStore.NextMatureDepositHeight, 1);
