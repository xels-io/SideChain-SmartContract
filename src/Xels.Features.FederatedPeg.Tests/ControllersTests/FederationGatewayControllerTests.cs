...
namespace Xels.Features.FederatedPeg.Tests.ControllersTests
{
    public class FederationGatewayControllerTests
    {
        ...
        public void Call_Sidechain_Gateway_Get_Info()
        {
            ...
            var federatedPegSettings = new FederatedPegSettings(nodeSettings, new CounterChainNetworkWrapper(KnownNetworks.XlcRegTest));
        ...
        private void CreateFederationManager(NodeSettings nodeSettings)
        {
            ...
            var counterChainSettings = new CounterChainSettings(nodeSettings, new CounterChainNetworkWrapper(new XlcRegTest()));
        ...
        public void Call_Mainchain_Gateway_Get_Info()
        {
            ...
            var settings = new FederatedPegSettings(nodeSettings, new CounterChainNetworkWrapper(KnownNetworks.XlcRegTest));
