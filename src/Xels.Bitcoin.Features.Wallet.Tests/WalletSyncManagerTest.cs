...
namespace Xels.Bitcoin.Features.Wallet.Tests
{
    public class WalletSyncManagerTest : LogsTestBase
    {
        ...
        {
            this.SetupMockObjects(new ChainIndexer(new XlcMain()));
        }

        private void SetupMockObjects(ChainIndexer chainIndexer, List<Block> blocks = null)
        {
            this.chainIndexer = chainIndexer;
            this.storeSettings = new StoreSettings(new NodeSettings(new XlcMain()));
        ...
        public void Start_HavingPrunedStoreSetting_ThrowsWalletException()
        {
            ...
            var walletSyncManager = new WalletSyncManager(this.LoggerFactory.Object, this.walletManager.Object, this.chainIndexer, new XlcMain(),
        ...
        */
        ...
        {
            this.storeSettings.AmountOfBlocksToKeep = 0;
            this.chainIndexer = WalletTestsHelpers.GenerateChainWithHeight(5, new XlcMain());
        ...
        */
        ...
        {
            (ChainIndexer Chain, List<Block> Blocks) result = WalletTestsHelpers.GenerateChainAndBlocksWithHeight(5, new XlcMain());
        ...
        {
            (ChainIndexer LeftChain, ChainIndexer RightChain, List<Block> LeftForkBlocks, List<Block> RightForkBlocks) result = WalletTestsHelpers.GenerateForkedChainAndBlocksWithHeight(5, new XlcMain(), 2);
        ...
        {
            this.SetupMockObjects(WalletTestsHelpers.GenerateChainWithHeight(5, new XlcMain()));
        ...
        {
            this.SetupMockObjects(WalletTestsHelpers.GenerateChainWithHeight(3, new XlcMain()));
        ...
        {
            this.SetupMockObjects(WalletTestsHelpers.GenerateChainWithHeight(1, new XlcMain()));
        ...
        {
            (ChainIndexer Chain, List<Block> Blocks) result = WalletTestsHelpers.GenerateChainAndBlocksWithHeight(1, new XlcMain());
