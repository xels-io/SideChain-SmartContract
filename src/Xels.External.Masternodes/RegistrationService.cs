...
namespace Xels.External.Masternodes
{
    public sealed class RegistrationService
    {
        ...
        public async Task StartAsync(NetworkType networkType)
        {
            ...
            this.nodeExecutablesPath = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "XlcMinerD");
        ...
        {
            var chainName = nodeType == NodeType.MainChain ? "XLC" : "CC";
