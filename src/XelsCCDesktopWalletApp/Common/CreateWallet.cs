...
namespace XelsCCDesktopWalletApp.Common
{
    ...
    public class CreateWallet
    {
        ...
        //{
        //    using (StreamReader r = new StreamReader(@"D:\All_Projects\xels-fullnode-wpf-v4\src\XelsCCDesktopWalletApp\Config\Token.json"))
        //    {
        //        string json = r.ReadToEnd();
