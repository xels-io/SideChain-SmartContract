...
namespace Xels.Bitcoin.Features.MemoryPool.Tests.PoS
{
    ...
    {
        public XelsMempoolValidatorTest() : base(new XlcRegTest())
        {
        }
        ...
        public async Task AcceptToMemoryPool_WithOpReturn_IsSuccessfulAsync()
        {
            ...
            var ops = new Op[XlcStandardScriptsRegistry.MaxOpReturnRelay];
        ...
        public async Task AcceptToMemoryPool_WithLargeOpReturn_ReturnsFalseAsync()
        {
            ...
            var ops = new Op[XlcStandardScriptsRegistry.MaxOpReturnRelay + 1];
            ops[0] = OpcodeType.OP_RETURN;
