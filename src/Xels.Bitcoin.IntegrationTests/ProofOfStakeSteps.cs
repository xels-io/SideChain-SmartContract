...
namespace Xels.Bitcoin.IntegrationTests
{
    public class ProofOfStakeSteps
    {
        ...
        {
            this.PremineNodeWithCoins = this.nodeBuilder.CreateXelsPosNode(new XlcRegTest(), testId).WithWallet().Start();
        }
        ...
        public void PremineNodeWithWalletWithOverrides()
        {
            ...
            this.PremineNodeWithCoins = this.nodeBuilder.CreateCustomNode(callback, new XlcRegTest(), ProtocolVersion.PROTOCOL_VERSION, agent: "mint-pmnode", configParameters: configParameters);
